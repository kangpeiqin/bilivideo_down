...
# 直接将编译好的文件打包成 bilivideo_down.zip
Compress-Archive -Path "$tempDir\*" -DestinationPath "bilivideo_down.zip" -Force
Compress-Archive -Path "$tempDir\*" -DestinationPath "biliVidoDown-windows-x86-64.zip" -Force
